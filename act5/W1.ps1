...
Write-Host "CREANDO ESTRUCTURA FTP EXACTA..."
$rutas = "C:\FTP", "C:\FTP\reprobados", "C:\FTP\recursadores", "C:\FTP\LocalUser", "C:\FTP\LocalUser\Public", "C:\FTP\LocalUser\Public\general"
foreach($r in $rutas){
